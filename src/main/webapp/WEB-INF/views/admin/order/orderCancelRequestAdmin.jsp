...
<head>
    ...
    <script type="text/javascript">
    	function orderCancelProcess(request_idx, order_idx, order_list_idx) {
		...
		<div class="w3-row-padding w3-padding-16">
			...
			<div class="w3-col m10 w3-margin-bottom">
				...
				<div class="text-center mt-3">
					<a class="w3-btn w3-2020-mosaic-blue" onclick="orderCancelProcess(${vo.order_cancel_request_idx},${vo.order_idx},${vo.order_list_idx});">요청 처리</a>&nbsp;
